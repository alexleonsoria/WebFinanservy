      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-2 bg-white border border-slate-200 p-8 md:p-10 rounded-sm shadow-sm space-y-8">
            ...
            {submitted ? (
              <div className="bg-slate-100 border border-slate-200 p-8 text-center rounded-sm space-y-4">
                ...
                <p className="text-xs text-slate-500 max-w-md mx-auto leading-relaxed">
                  Gracias por contactarnos. Un Ejecutivo Senior del Grupo Cibernos ha sido asignado a su caso y se pondrá en contacto con usted a la brevedad.
                </p>
              </div>
            ) : (
