      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {serviceCards.map((card, idx) => (
            <div key={idx} className="bg-white border border-slate-200 p-8 md:p-10 rounded-sm hover-lift flex flex-col justify-between">
              ...
              <div className="pt-8 border-t border-slate-100 mt-6 flex justify-between items-center">
                <span className="text-xs text-slate-400 font-mono">NEXT.JS ROUTE: {card.link}</span>
